...
//
// ИСТОРИЯ ИЗМЕНЕНИЙ:
// 2026-07-18: добавлены "Mobile Apps", "PC Apps" — giftapi отдаёт
// английские категории для некоторых товаров.
// 2026-07-19: добавлена "Мобильные приложения" (русская) — именно
// такая категория приходит в API для Apple Gift Card, Google Play и т.д.
// Ранее была только "Мобильные приложения" в games, но giftapi
// относит эти товары к покупкам (gift cards), не к играм.
